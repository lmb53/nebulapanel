...
<div class="page-header">
  ...
  <?php if ($users): ?><form method="get" class="page-actions"><input type="hidden" name="r" value="sshkeys"><select class="select" name="user" id="sshUserSelect"><?php foreach ($users as $u): ?><option value="<?= e($u['name']) ?>" <?= $u['name'] === $selected ? 'selected' : '' ?>><?= e($u['name']) ?> — <?= e($u['home']) ?></option><?php endforeach; ?></select></form><?php endif; ?>
</div>
